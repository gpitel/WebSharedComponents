...
export interface InsulationRequirements {
    ...
    cti?: CTI;
    /**
     * Required certified electrical insulation system (EIS), e.g. per UL 1446 / IEC 60085. The
     * thermal class bounds which insulation materials and wire coatings may be used.
     */
    insulationSystem?: InsulationSystemRequirement;
 ...
 * thermal class bounds which insulation materials and wire coatings may be used.
 */
export interface InsulationSystemRequirement {
    /**
     * Materials approved for this system (e.g. the UL 1446 approved-materials list), each with
     * the functions it is approved for. When present, insulation layer materials are restricted
     * to the entries approved for layer-type uses (groundInsulation, tape, minorSheet). Entries
     * for other uses (magnetWire, bobbin, varnish, ...) document the system but are not matched
     * against wires or parts.
     */
    allowedMaterials?: InsulationSystemMaterial[];
    /**
     * Certificate or file number of the system, e.g. UL E65007
     */
    certificate?: string;
    /**
     * Organization certifying the system, e.g. UL, VDE, Nemko
     */
    certifyingOrganization?: string;
    /**
     * Name of the certified system, e.g. QT-180T
     */
    name?: string;
    /**
     * Required thermal class of the insulation system, e.g. 180 or "H"
     */
    temperatureClass: number | TemperatureClassEnum;
}

export interface InsulationSystemMaterial {
    /**
     * Material name, e.g. Nomex 410, Rynite 530, CC-1105
     */
    name: string;
    /**
     * Functions this material is approved for in the system, per the UL 1446 component
     * categories. Absent = approved for any use.
     */
    uses?: InsulationMaterialUse[];
}

export enum InsulationMaterialUse {
    Bobbin = "bobbin",
    GroundInsulation = "groundInsulation",
    LeadWire = "leadWire",
    MagnetWire = "magnetWire",
    MinorSheet = "minorSheet",
    PottingCompound = "pottingCompound",
    Sleeving = "sleeving",
    SpacerWedge = "spacerWedge",
    Tape = "tape",
    TieCord = "tieCord",
    Varnish = "varnish",
}
...
const typeMap: any = {
    ...
    "InsulationRequirements": o([
        ...
        { json: "insulationSystem", js: "insulationSystem", typ: u(undefined, r("InsulationSystemRequirement")) },
    ...
    "InsulationSystemRequirement": o([
        { json: "allowedMaterials", js: "allowedMaterials", typ: u(undefined, a(r("InsulationSystemMaterial"))) },
        { json: "certificate", js: "certificate", typ: u(undefined, "") },
        { json: "certifyingOrganization", js: "certifyingOrganization", typ: u(undefined, "") },
        { json: "name", js: "name", typ: u(undefined, "") },
        { json: "temperatureClass", js: "temperatureClass", typ: u(3.14, r("TemperatureClassEnum")) },
    ], false),
    "InsulationSystemMaterial": o([
        { json: "name", js: "name", typ: "" },
        { json: "uses", js: "uses", typ: u(undefined, a(r("InsulationMaterialUse"))) },
    ], false),
    "MaximumDimensions": o([
